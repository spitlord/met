...
public class WelcomeDialog {
    ...
    MetroWorkspace workspace = App.app.getWorkspace();
    ...
    static void getRecentFileArrayAndPutInBox(Stage stage, VBox box, MetroWorkspace workspace) {
