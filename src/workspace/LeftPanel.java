   ...
   Button reduceMapButton;
    ...
    private void initControllers() {
        ...
        lineThicknessSlider.setOnMousePressed(e -> {
            controllers.handleSetLineThickness(MouseState.PRESSED, lineThicknessSlider.getValue());
            e.consume();
        });
        lineThicknessSlider.setOnMouseDragged(e -> {
            controllers.handleSetLineThickness(MouseState.DRAGGED, lineThicknessSlider.getValue());
            e.consume();
        });
        lineThicknessSlider.setOnMouseReleased(e -> {
            controllers.handleSetLineThickness(MouseState.RELEASED, lineThicknessSlider.getValue());
            e.consume();
        });
        ...
        stationRadiusSlider.setOnMousePressed(e -> {
            controllers.handleStationRadiusSlider(MouseState.PRESSED, stationRadiusSlider.getValue());
            e.consume();
        } );
        stationRadiusSlider.setOnMouseDragged(e -> {
            controllers.handleStationRadiusSlider(MouseState.DRAGGED, stationRadiusSlider.getValue());
            e.consume();
        } );
        stationRadiusSlider.setOnMouseReleased(e -> {
            controllers.handleStationRadiusSlider(MouseState.RELEASED, stationRadiusSlider.getValue());
            e.consume();
        } );
